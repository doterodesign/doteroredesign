...
const cs__fueltime = caseStudies[1];
const cs__blah = caseStudies[2];
const cs__ipc = caseStudies[3];
const cs__salvationarmy = caseStudies[4];
const cs__gladwell = caseStudies[5];
